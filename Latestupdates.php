...
<head>
    ...
    <style>
        ...
        #editPopup button:first-child {
            background-color: #ff0000;
            color: white;
            margin-right: 10px;
        }

        #editPopup button:first-child:hover {
            background-color: #cc0000;
            transform: scale(1.05);
        }

        #editPopup button:last-child {
            background-color: #e0e0e0;
            color: #333;
        }

        #editPopup button:last-child:hover {
...
<body>
    ...
    <div class="updates">
        ...
        <form id="myForm" action="submit_update.php" method="POST">
            ...
            <button type="button" onclick="showConfirmModal()">Submit</button>
        </form>
        <div id="confirmationModal" class="modal">
            <div class="modal-content">
                <p>Are You Sure to Submit The Post?</p>
            ...
            fetch('get_updates.php')
                ...
                .then(updates => {
                    ...
                    updates.forEach(update => {
                        ...
                        `;
                        row.querySelector('.edit').onclick = () => editUpdate(update.id);
                        row.querySelector('.delete').onclick = () => deleteUpdate(update.id);
